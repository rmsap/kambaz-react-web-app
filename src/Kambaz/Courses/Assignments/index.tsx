    ...
    <div id="wd-assignments">
      ...
      <ul id="wd-assignment-list">
        <li className="wd-assignment-list-item">
          ...
          am | <strong>Due</strong> May 13 at 11:59 pm | 100 points
        </li>
        <li className="wd-assignment-list-item">
          <a
            href="#/Kambaz/Courses/1234/Assignments/123"
          ...
          12:00 am | <strong>Due</strong> May 20 at 11:59 pm | 100 points
        </li>
        <li className="wd-assignment-list-item">
          <a
            href="#/Kambaz/Courses/1234/Assignments/123"
          ...
          12:00 am | <strong>Due</strong> May 27 at 11:59 pm | 100 points
        </li>
      </ul>
    </div>
  );
